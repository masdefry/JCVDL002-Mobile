            ...
            <Content>
                {
                    dataShuttleList?
                        dataShuttleList.map((val, index) => {
                            return(
                                <Grid key={index} onPress={() => navigate('ShuttleDetail', {id: val.id, totalSeat: dataSearch.totalSeat})} style={{ ...Spacing.pxFive, ...Spacing.pyFive, borderBottomWidth: 1, borderColor: 'gray' }}>
                                    <Row>
                                        <Col>
